...
LOAD_FOLDER = "stateful_data/activities/"
SAVE_FOLDER = "build/lights-only-overlapping/activities/"
...
def main():
    ...
    for window_num in range(num_windows):
        input_window, output_window = get_window(lines, window_num, WINDOW_SIZE, num_lights)
...
def get_window(lines, window_num, window_size, num_lights):
